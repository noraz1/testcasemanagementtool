...
<?php 
   ...
   $fetched_row=mysql_fetch_array($result1);
     $projectid= $fetched_row['projectid'];
                                                $projectname= $fetched_row['projectname'];
                                                 $projectdesc= $fetched_row['projectdesc'];
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="card">
                              ...
                              <table class="table table-hover table-striped">
                                    ...
                                    <div id="id01" class="w3-modal">
                                       <divclass ="w3-modal-content">
                                          <div class="w3-container">
                                             ...
                                             <!-- HTML Form (wrapped in a .bootstrap-iso div) -->                                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <a href="#edit<?php echo $projectid;?>" data-toggle="modal"><button type='button' class='btn btn-warning btn-sm'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></button></a>
                                          <a  href="#delete<?php echo $projectid;?>" data-toggle="modal"><button type='button' class='btn btn-danger btn-sm'><span  class='glyphicon glyphicon-trash' aria-hidden='true'></span></button></a>
                           </div>
                           </td>
                           </tr>
                           <?php 
                              $i++;
                                               ...
                                               if(isset($_POST['delete'])){
                                                 ...
                                                 $res = mysql_query("DELETE from project WHERE projectid ='$delete_id' ");
                                                  if ($res === TRUE) {
                           ...
                           <!--Delete Modal -->
                           <div id="delete<?php echo $projectid; ?>" tabindex="-1" class="modal fade" role="dialog" >
                                 ...
                                 <form method="post">
                                    ...
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          <input type="hidden" name="delete_id" value="<?php echo $projectid; ?>">
                                          <p>
                                          <div class="alert alert-danger">Are you Sure you want Delete <strong><?php echo $projectname; ?>?</strong></p>
                                          </div>
